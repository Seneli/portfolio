import { todo_list_img, personal_website_img } from "../images/projects/index";
...
var projects = [
  {
    ...
    description:
      'A full stack website Youngjun and I made in 2021 for PTC to host a competetive coding competition for highschoolers. The website had the ability for participants to log into and sign up for accounts, reset their password and submit .txt files of their code. There was also a leaderboard for users and an admin account that could be used to view participant submissions and submit grades.',
  ...
  },
  {
    ...
    description:
      'The Covid Rapid Screener is a project I made with a group of 3 that can detect if a user was wearing a mask or has a body temperature over 38 degrees.',
  ...
  },
  {
    ...
    description:
      'This was the first app I made with HTML, CSS and Javascript. It lets you add, select and delete tasks to a to-do list.',
